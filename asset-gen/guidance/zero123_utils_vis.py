...
if __name__ == '__main__':
    ...
    parser.add_argument('--radius', type=float, default=-0.5, help='delta camera radius multiplier in [-0.5, 0.5]')
    ...
    for degree in degrees:
        ...
        for i in range(2):
            ...
            plt.savefig(f'img_p={opt.polar}_a={opt.azimuth}_r={opt.radius}.png')
    #plt.show()