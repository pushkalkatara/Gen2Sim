...
# static_object_init_pose_p_np = np.array([-2.1, -0.3, 1.0])
# static_object_init_pose_r_np = np.array([0.,0.,1.,0.])
# static_object_init_pose_p = gymapi.Vec3(-2.1, -0.3, 1.0)
# static_object_init_pose_r = gymapi.Quat(0.,0.,1.,0.)

# static_object_init_pose_p_np = np.array([-1.8, 0.4, 1.2])
# static_object_init_pose_r_np = np.array([0.,0.,1.,0.])
# static_object_init_pose_p = gymapi.Vec3(-1.8, 0.4, 1.2)
# static_object_init_pose_r = gymapi.Quat(0.,0.,1.,0.)


# static_object_init_pose_p_np = np.array([-0.7, -0.3, 2.4])
# static_object_init_pose_r_np = np.array([0.7071,0.,0.,0.7071])
# static_object_init_pose_p = gymapi.Vec3(-0.7, -0.3, 2.4)
# static_object_init_pose_r = gymapi.Quat(0.7071,0.,0.,0.7071)
